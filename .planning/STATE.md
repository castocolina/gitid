...
| 260922-cpl | Fix CI failures masked behind earlier red steps: step-0 Host-block preview clipped at 100x30 since e156586 (3 rows recovered), stale gign-receipt screenshot script, fedora-root chmod-0000 tests (probe-based skip) and gh-on-PATH dependency (LookPath stub); executed via cross-AI opencode | 2026-09-22 | 0cdfd67 | [260922-cpl-fix-masked-ci-failures-screenshot-region](./quick/260922-cpl-fix-masked-ci-failures-screenshot-region/) |
